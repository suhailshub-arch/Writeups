...
| :--: |
|*Failed Anonymous and Guest SMB Authentication* |

| ![Failed Anonymous RPC Authentication ](./Evidence/RPC%20Enum.png) |
| :--: |
| *Failed Anonymous RPC Authentication* |
...
| :--: |
| *Names of employees found in the About Us page* |  |

## Initial Access

Now that we have a bigger list of usernames, we can attempt ASREPRoasting attack again. 

| ![ASREPRoasting](./Evidence/ASREPRoast%20Output.png) |
| :--: |
| *Hash found for a user*|
...
| :--: |
| *Path to Domain Admin from "svc_loanmgr"* |
...
| :--: |
| *Retrieve hash of Administrator!* |
...
| :--: |
| *Able to Authenticate as Administrator on WinRM* |
